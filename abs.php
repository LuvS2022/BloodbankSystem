    ...
    <div class="container cont">
        ...
        <div class="row col-lg-8 col-md-8 col-sm-12 mb-3">
            ...
            <label class="font-weight-bolder">Select Blood Group:</label>
               ...
               <a href="index.php" class="btn btn-secondary" style="margin-left: 450px;">Go Back</a>
               <?php } ?>
           </form>
        </div>
        ...
        <table class="table table-responsive table-striped rounded mb-5">
            ...
            <div>
                ...
                if ($result) {
                    ...
                    if ($row) {
                }else echo '<b style="color:white;background-color:red;padding:7px;border-radius: 15px 50px;">No Available Blood Samples.</b>';
            }
            ?>
            </div>
